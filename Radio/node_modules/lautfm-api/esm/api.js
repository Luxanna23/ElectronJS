...
export var stationsByGenre =
/*#__PURE__*/
function () {
  var _ref21 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee21(genre) {
    var options,
        cops,
        resp,
        _args21 = arguments;
      ...
      while (1) {
        switch (_context21.prev = _context21.next) {
          case 0:
            ...
            cops = assignOptions(options);
            _context21.next = 4;
            return query("stations/genre/".concat(genre), cops);
  ...
  return function stationsByGenre(_x9) {
